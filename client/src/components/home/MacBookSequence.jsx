...
export function MacBookSequence({ sectionRef }) {
  ...
  useEffect(() => {
    ...
    function measure() {
      ...
      cachedStartY = sec.offsetTop <= 120 ? 0 : sec.offsetTop;
    }
    measure();
    ...
    function onScroll() {
      ...
      const scrolledIn = window.scrollY - cachedStartY;
    ...
    function tick() {
      ...
      if (Math.abs(targetRef.current - smoothRef.current) < 0.05 && f === drawnRef.current) {
        isRunning = false;
        return;
      }
  ...
  return (
    ...
    >
      ...
      <img
        src="/animations/macbook/ezgif-frame-001.webp"
