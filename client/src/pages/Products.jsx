...
const products = [
  ...
  {
    id: 7,
    name: "ProVision Mirrorless Camera",
    category: "Cameras",
    price: 329000,
    rating: 5,
    reviews: 31,
          ...
          <div className="mx-auto max-w-7xl px-6 py-20">
            ...
            >
              ...
              <p className="mt-6 max-w-xl text-sm leading-7 text-gray-500 sm:text-base">
                Discover premium electronics, gaming hardware,
                smart devices and technology built for what's next.
              </p>
            </motion.div>
          ...
          <div className="mx-auto max-w-7xl px-6 py-24">
            ...
            <div className="relative overflow-hidden border border-white/10 bg-[#080808] px-8 py-16 sm:px-12">
              ...
              <p className="relative mt-5 max-w-xl text-sm leading-7 text-gray-500">
                Our intelligent shopping experience will
                help you discover products based on your
