                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="relative h-20 w-20 shrink-0 overflow-hidden rounded-xl border border-white/10 bg-black">
                                ...
                                {discount >
                                  0 && (
                                  <span className="absolute left-1 top-1 z-10 rounded bg-[#00E5FF] px-1.5 py-0.5 text-[7px] font-bold text-black">
                                    -{discount}%
                                  </span>
                                )}
                              ...
                              <div className="min-w-0 flex-1">
                                ...
                                <div className="mt-2 flex flex-wrap items-center gap-2">
                                  ...
                                  {discount >
                                    0 && (
                                    <span className="inline-flex items-center gap-1 rounded-md bg-[#00E5FF]/10 px-2 py-1 text-[9px] text-[#00E5FF]">
                                      <Tag
                                        size={
                                          9
                                        }
